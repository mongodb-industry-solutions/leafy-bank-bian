...
export const OPEN_FINANCE_TALK_TRACK = [
  {
    ...
    content: [
      {
        body: [
          "Understand how this solution demonstrates a next-generation Open Banking experience using MongoDB Atlas and agentic AI.",
      ...
      },
      {
        ...
        body: [
          "Two retail customers are available for the Open Banking journey:",
          "",
    ...
    content: [
      {
        body: [
          ...
          "- **Separating data in a dual-database architecture**: internal (`leafy_bank_bian`) and external (`leafy_bank_openbanking`) aligned with Open Banking transaction models.",
